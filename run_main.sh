...
python3 grid_search.py --data /users/bjoo2/data/bjoo2/scratch/csam_data/csam10 --pred TER --chkpt_path /users/bjoo2/data/bjoo2/scratch/csam_data/checkpoints --img_path /users/bjoo2/data/bjoo2/scratch/csam_data/graphs --results_path /users/bjoo2/data/bjoo2/scratch/csam_data/text_out
