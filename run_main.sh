...
python3 grid_search.py --data /users/bjoo2/data/bjoo2/qbam/data --pred Both --chkpt_path /users/bjoo2/code/qbam/qbam_gnn/checkpoints --img_path /users/bjoo2/code/qbam/qbam_gnn/graphs --results_path /users/bjoo2/code/qbam/qbam_gnn/text_out