...
def main(args):
    ...
    if args.dataset == "Healthy":
        ...
        data_dirs = {"train": [f"{data_base_dir}/{args.dataset}/Train_{args.pred}.pkl"], 
                    "valid": [f"{data_base_dir}/{args.dataset}/Valid_{args.pred}.pkl"], 
                    "test":  [f"{data_base_dir}/{args.dataset}/Test_{args.pred}.pkl"]}
