...
#SBATCH --partition=gpu --gres=gpu:1 --output=dnn-f_amd_both.out
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -t 60:00:00
#SBATCH --mem=100g
...
echo "Training DNN F on Both"
python3 train_dnnf.py --data /users/bjoo2/data/bjoo2/qbam/data --pred Both --dataset AMD --batch_size 32 
