...
#SBATCH --partition=gpu --gres=gpu:1  --output=optuna_all.out
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -t 08:00:00
#SBATCH --mem=16g
...
do
    ...
    python3 optuna_search.py --data /users/bjoo2/data/bjoo2/qbam/data --dataset AMD --pred "$i" --save_path "/users/bjoo2/data/bjoo2/qbam/data/weights/$i"
...
do
    echo "Optuna Searching on $i"
    python3 optuna_search.py --data /users/bjoo2/data/bjoo2/qbam/data --pred "$i" --dataset AMD --multi_opt --save_path "/users/bjoo2/data/bjoo2/qbam/data/weights/$i"
done
