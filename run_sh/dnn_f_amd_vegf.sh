...
#SBATCH --partition=gpu --gres=gpu:1 --output=dnn-f_amd_vegf.out
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -t 60:00:00
#SBATCH --mem=50g
...
echo "Training DNN F on VEGF"
python3 train_dnnf.py --data /users/bjoo2/data/bjoo2/qbam/data --pred VEGF --dataset AMD --batch_size 32 
