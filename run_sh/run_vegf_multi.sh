...
python3 optuna_search.py --data /users/bjoo2/data/bjoo2/qbam/data --pred VEGF --dataset AMD --multi_opt --save_path /users/bjoo2/data/bjoo2/qbam/data/weights/VEGF